...
- Format `json!` bodies with `eden-fmt`: `pnpm rust:check` and `pnpm rust:fmt` run it, and [the macro call standard](docs/development-checks.md#macro-call-formatting) states the shape it enforces.

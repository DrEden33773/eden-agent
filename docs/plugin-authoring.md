...
Use the SDK source from the same eden-agent release and Rust 1.98.1. Host and plugin must match `eden-native-0.3.0`, ABI version 1 and the target triple. There is no cross-release ABI compatibility promise.
